...
An interactive prerequisite graph for UC San Diego courses. Search any course and explore what you need to take before it, or what it unlocks — all without a backend server.
